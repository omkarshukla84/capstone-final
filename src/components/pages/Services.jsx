...
const imagePath = "http://localhost:5173/images/";
...
function Services() {
  ...
  useEffect(() => {
    ...
    tag === "all"
      ...
      : setFilteredServices(
          servicesData.filter((service) => service.tag === tag)
        );
  }, [tag]);
        ...
        <Row>
          <Col xs="12">
            <div className="tags">
              ...
              <TagButton
                name="hotel"
                tagActive={tag === "hotel" ? true : false}
                handleSetTag={setTag}
              />
              <TagButton
                name="villa"
                tagActive={tag === "villa" ? true : false}
                handleSetTag={setTag}
              />
            </div>
          </Col>
                  ...
                  >
                    <Row>
                      <Col md="6" style={{ paddingRight: "0px" }}>
                        ...
                        <ImageSlider
                          images={imgArr}
                          className="service-slider-images"
                        >
                          <div
                            style={{
                              display: "flex",
